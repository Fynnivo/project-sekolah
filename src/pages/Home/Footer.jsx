...
const FooterComponent = () => {
  return (
<footer className="p-4 bg-[#ede9fe] sm:p-6 dark:bg-gray-900">
    <div className='container w-4/5 mx-auto'>
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href='/' className='flex items-center'>
                <img src={Logo} className="mr-3 h-8" alt="IkhwanLogo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ikhwan</span>
            </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://flowbite.com/" className="hover:underline">Ikhwan</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Ikhwan™</a>. All Rights Reserved.
        </span>
