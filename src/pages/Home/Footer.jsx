        ...
        <footer className="p-4 bg-[#ede9fe] sm:p-6 dark:bg-gray-900">
            <div className='container w-4/5 mx-auto'>
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link to="/about" className="hover:underline">Ikhwan</Link>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link to="/about" className="hover:underline">Ikhwan™</Link>. All Rights Reserved.
                    </span>
